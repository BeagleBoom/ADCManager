...
//  Chip Select:  P9.27 pr1_pru0_pru_r30_5 // ändern: P8.20 pr1_pru1_pru_r30_130xFFFFDFFF
...
#define CLK_HIGH __R30 = __R30 | 0x00000200
#define CLK_LOW __R30 = __R30 & 0xFFFFFDFF
